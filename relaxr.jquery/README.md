...
Copy the `starter_code` directory into your `homework_portfolio` repository and rename it to `jquery_relaxr`. Complete the assignment as specified above. Then commit and push your changes as usual.
